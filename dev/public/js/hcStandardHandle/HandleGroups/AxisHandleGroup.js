...
export class AxisHandleGroup extends StandardHandleGroup {
    ...
    async show(nodeids, center = null, rotation = null) {
        ...
        this._handles.push(new AxisHandle(this,new Communicator.Point3(0,1,0),90,new Communicator.Color(0,0,255)));
        this._handles.push(new AxisHandle(this,new Communicator.Point3(1,0,0),90,new Communicator.Color(0,200,0)));
